 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getDiscriminant <em>Discriminant</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getAlternative <em>Alternative</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getSemantics <em>Semantics</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.VariantRecordDataTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariantRecordDataTypeImpl extends MinimalEObjectImpl.Container implements VariantRecordDataType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getVariantRecordDataType();
	}
	...
	public NotificationChain basicSetName(IdentifierType newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__NAME, oldName, newName);
	...
	public void setName(IdentifierType newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetDiscriminant(IdentifierType newDiscriminant, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__DISCRIMINANT, oldDiscriminant, newDiscriminant);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDiscriminant(IdentifierType newDiscriminant) {
		if (newDiscriminant != discriminant) {
			...
			if (discriminant != null)
				msgs = ((InternalEObject)discriminant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__DISCRIMINANT, null, msgs);
			if (newDiscriminant != null)
				msgs = ((InternalEObject)newDiscriminant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__DISCRIMINANT, null, msgs);
			msgs = basicSetDiscriminant(newDiscriminant, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__DISCRIMINANT, newDiscriminant, newDiscriminant));
	}
	...
	public NotificationChain basicSetDataType(ReferenceType newDataType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__DATA_TYPE, oldDataType, newDataType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataType(ReferenceType newDataType) {
		if (newDataType != dataType) {
			NotificationChain msgs = null;
			if (dataType != null)
				msgs = ((InternalEObject)dataType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__DATA_TYPE, null, msgs);
			if (newDataType != null)
				msgs = ((InternalEObject)newDataType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__DATA_TYPE, null, msgs);
			msgs = basicSetDataType(newDataType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__DATA_TYPE, newDataType, newDataType));
	}
	...
	public EList<AlternativeType> getAlternative() {
		if (alternative == null) {
			alternative = new EObjectContainmentEList<AlternativeType>(AlternativeType.class, this, OmtPackage.VARIANT_RECORD_DATA_TYPE__ALTERNATIVE);
		}
		return alternative;
	}
	...
	public NotificationChain basicSetEncoding(VariantRecordEncodingType newEncoding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__ENCODING, oldEncoding, newEncoding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEncoding(VariantRecordEncodingType newEncoding) {
		if (newEncoding != encoding) {
			NotificationChain msgs = null;
			if (encoding != null)
				msgs = ((InternalEObject)encoding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__ENCODING, null, msgs);
			if (newEncoding != null)
				msgs = ((InternalEObject)newEncoding).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__ENCODING, null, msgs);
			msgs = basicSetEncoding(newEncoding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__ENCODING, newEncoding, newEncoding));
	}
	...
	public NotificationChain basicSetSemantics(edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.String newSemantics, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__SEMANTICS, oldSemantics, newSemantics);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSemantics(edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.String newSemantics) {
		if (newSemantics != semantics) {
			NotificationChain msgs = null;
			if (semantics != null)
				msgs = ((InternalEObject)semantics).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__SEMANTICS, null, msgs);
			if (newSemantics != null)
				msgs = ((InternalEObject)newSemantics).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.VARIANT_RECORD_DATA_TYPE__SEMANTICS, null, msgs);
			msgs = basicSetSemantics(newSemantics, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__SEMANTICS, newSemantics, newSemantics));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, OmtPackage.VARIANT_RECORD_DATA_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIdtag(String newIdtag) {
		...
		idtag = newIdtag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.VARIANT_RECORD_DATA_TYPE__NOTES, oldNotes, notes));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.VARIANT_RECORD_DATA_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
