 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#getIsCallback <em>Is Callback</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#isIsUsed <em>Is Used</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfirmAttributeOwnershipAcquisitionCancellationTypeImpl extends MinimalEObjectImpl.Container implements ConfirmAttributeOwnershipAcquisitionCancellationType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setIsCallback(Object newIsCallback) {
		...
		isCallbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__IS_CALLBACK, oldIsCallback, isCallback, !oldIsCallbackESet));
	}
	...
	public void unsetIsCallback() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__IS_CALLBACK, oldIsCallback, IS_CALLBACK_EDEFAULT, oldIsCallbackESet));
	}
	...
	public void setIsUsed(boolean newIsUsed) {
		...
		isUsedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__IS_USED, oldIsUsed, isUsed, !oldIsUsedESet));
	}
	...
	public void unsetIsUsed() {
		...
		isUsedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__IS_USED, oldIsUsed, IS_USED_EDEFAULT, oldIsUsedESet));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setSection(Object newSection) {
		...
		sectionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.CONFIRM_ATTRIBUTE_OWNERSHIP_ACQUISITION_CANCELLATION_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
