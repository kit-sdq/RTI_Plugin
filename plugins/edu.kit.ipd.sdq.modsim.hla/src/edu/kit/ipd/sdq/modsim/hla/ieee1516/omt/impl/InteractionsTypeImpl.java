 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.InteractionsTypeImpl#getInteractionClass <em>Interaction Class</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.InteractionsTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.InteractionsTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.InteractionsTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.InteractionsTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionsTypeImpl extends MinimalEObjectImpl.Container implements InteractionsType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getInteractionsType();
	}
	...
	public NotificationChain basicSetInteractionClass(InteractionClassType1 newInteractionClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.INTERACTIONS_TYPE__INTERACTION_CLASS, oldInteractionClass, newInteractionClass);
	...
	public void setInteractionClass(InteractionClassType1 newInteractionClass) {
		if (newInteractionClass != interactionClass) {
			...
			if (interactionClass != null)
				msgs = ((InternalEObject)interactionClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.INTERACTIONS_TYPE__INTERACTION_CLASS, null, msgs);
			if (newInteractionClass != null)
				msgs = ((InternalEObject)newInteractionClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.INTERACTIONS_TYPE__INTERACTION_CLASS, null, msgs);
			msgs = basicSetInteractionClass(newInteractionClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.INTERACTIONS_TYPE__INTERACTION_CLASS, newInteractionClass, newInteractionClass));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, OmtPackage.INTERACTIONS_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIdtag(String newIdtag) {
		...
		idtag = newIdtag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.INTERACTIONS_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.INTERACTIONS_TYPE__NOTES, oldNotes, notes));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.INTERACTIONS_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OmtPackage.INTERACTIONS_TYPE__INTERACTION_CLASS:
				return basicSetInteractionClass(null, msgs);
			case OmtPackage.INTERACTIONS_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case OmtPackage.INTERACTIONS_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OmtPackage.INTERACTIONS_TYPE__IDTAG:
				return getIdtag();
			case OmtPackage.INTERACTIONS_TYPE__NOTES:
				return getNotes();
			case OmtPackage.INTERACTIONS_TYPE__ANY_ATTRIBUTE:
