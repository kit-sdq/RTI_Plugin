 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getModelIdentification <em>Model Identification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getServiceUtilization <em>Service Utilization</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getObjects <em>Objects</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getInteractions <em>Interactions</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getDimensions <em>Dimensions</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getTime <em>Time</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getSynchronizations <em>Synchronizations</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getTransportations <em>Transportations</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getSwitches <em>Switches</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getUpdateRates <em>Update Rates</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getDataTypes <em>Data Types</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getNotes1 <em>Notes1</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.ObjectModelTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectModelTypeImpl extends MinimalEObjectImpl.Container implements ObjectModelType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getObjectModelType();
	}
	...
	public NotificationChain basicSetModelIdentification(ModelIdentificationType newModelIdentification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__MODEL_IDENTIFICATION, oldModelIdentification, newModelIdentification);
	...
	public void setModelIdentification(ModelIdentificationType newModelIdentification) {
		if (newModelIdentification != modelIdentification) {
			...
			if (modelIdentification != null)
				msgs = ((InternalEObject)modelIdentification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__MODEL_IDENTIFICATION, null, msgs);
			if (newModelIdentification != null)
				msgs = ((InternalEObject)newModelIdentification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__MODEL_IDENTIFICATION, null, msgs);
			msgs = basicSetModelIdentification(newModelIdentification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__MODEL_IDENTIFICATION, newModelIdentification, newModelIdentification));
	}
	...
	public NotificationChain basicSetServiceUtilization(ServiceUtilizationType newServiceUtilization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SERVICE_UTILIZATION, oldServiceUtilization, newServiceUtilization);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setServiceUtilization(ServiceUtilizationType newServiceUtilization) {
		if (newServiceUtilization != serviceUtilization) {
			...
			if (serviceUtilization != null)
				msgs = ((InternalEObject)serviceUtilization).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SERVICE_UTILIZATION, null, msgs);
			if (newServiceUtilization != null)
				msgs = ((InternalEObject)newServiceUtilization).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SERVICE_UTILIZATION, null, msgs);
			msgs = basicSetServiceUtilization(newServiceUtilization, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SERVICE_UTILIZATION, newServiceUtilization, newServiceUtilization));
	}
	...
	public NotificationChain basicSetObjects(ObjectsType newObjects, NotificationChain msgs) {
		...
		objects = newObjects;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__OBJECTS, oldObjects, newObjects);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setObjects(ObjectsType newObjects) {
		if (newObjects != objects) {
			NotificationChain msgs = null;
			if (objects != null)
				msgs = ((InternalEObject)objects).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__OBJECTS, null, msgs);
			if (newObjects != null)
				msgs = ((InternalEObject)newObjects).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__OBJECTS, null, msgs);
			msgs = basicSetObjects(newObjects, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__OBJECTS, newObjects, newObjects));
	}
	...
	public NotificationChain basicSetInteractions(InteractionsType newInteractions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__INTERACTIONS, oldInteractions, newInteractions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInteractions(InteractionsType newInteractions) {
		if (newInteractions != interactions) {
			...
			if (interactions != null)
				msgs = ((InternalEObject)interactions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__INTERACTIONS, null, msgs);
			if (newInteractions != null)
				msgs = ((InternalEObject)newInteractions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__INTERACTIONS, null, msgs);
			msgs = basicSetInteractions(newInteractions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__INTERACTIONS, newInteractions, newInteractions));
	}
	...
	public NotificationChain basicSetDimensions(DimensionsType1 newDimensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__DIMENSIONS, oldDimensions, newDimensions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDimensions(DimensionsType1 newDimensions) {
		if (newDimensions != dimensions) {
			NotificationChain msgs = null;
			if (dimensions != null)
				msgs = ((InternalEObject)dimensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__DIMENSIONS, null, msgs);
			if (newDimensions != null)
				msgs = ((InternalEObject)newDimensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__DIMENSIONS, null, msgs);
			msgs = basicSetDimensions(newDimensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__DIMENSIONS, newDimensions, newDimensions));
	}
	...
	public NotificationChain basicSetTime(TimeType newTime, NotificationChain msgs) {
		...
		time = newTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TIME, oldTime, newTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTime(TimeType newTime) {
		if (newTime != time) {
			NotificationChain msgs = null;
			if (time != null)
				msgs = ((InternalEObject)time).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TIME, null, msgs);
			if (newTime != null)
				msgs = ((InternalEObject)newTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TIME, null, msgs);
			msgs = basicSetTime(newTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TIME, newTime, newTime));
	}
	...
	public NotificationChain basicSetTags(TagsType newTags, NotificationChain msgs) {
		...
		tags = newTags;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TAGS, oldTags, newTags);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTags(TagsType newTags) {
		if (newTags != tags) {
			NotificationChain msgs = null;
			if (tags != null)
				msgs = ((InternalEObject)tags).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TAGS, null, msgs);
			if (newTags != null)
				msgs = ((InternalEObject)newTags).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TAGS, null, msgs);
			msgs = basicSetTags(newTags, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TAGS, newTags, newTags));
	}
	...
	public NotificationChain basicSetSynchronizations(SynchronizationsType newSynchronizations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SYNCHRONIZATIONS, oldSynchronizations, newSynchronizations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSynchronizations(SynchronizationsType newSynchronizations) {
		if (newSynchronizations != synchronizations) {
			...
			if (synchronizations != null)
				msgs = ((InternalEObject)synchronizations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SYNCHRONIZATIONS, null, msgs);
			if (newSynchronizations != null)
				msgs = ((InternalEObject)newSynchronizations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SYNCHRONIZATIONS, null, msgs);
			msgs = basicSetSynchronizations(newSynchronizations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SYNCHRONIZATIONS, newSynchronizations, newSynchronizations));
	}
	...
	public NotificationChain basicSetTransportations(TransportationsType newTransportations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TRANSPORTATIONS, oldTransportations, newTransportations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransportations(TransportationsType newTransportations) {
		if (newTransportations != transportations) {
			...
			if (transportations != null)
				msgs = ((InternalEObject)transportations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TRANSPORTATIONS, null, msgs);
			if (newTransportations != null)
				msgs = ((InternalEObject)newTransportations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__TRANSPORTATIONS, null, msgs);
			msgs = basicSetTransportations(newTransportations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__TRANSPORTATIONS, newTransportations, newTransportations));
	}
	...
	public NotificationChain basicSetSwitches(SwitchesType newSwitches, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SWITCHES, oldSwitches, newSwitches);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSwitches(SwitchesType newSwitches) {
		if (newSwitches != switches) {
			NotificationChain msgs = null;
			if (switches != null)
				msgs = ((InternalEObject)switches).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SWITCHES, null, msgs);
			if (newSwitches != null)
				msgs = ((InternalEObject)newSwitches).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__SWITCHES, null, msgs);
			msgs = basicSetSwitches(newSwitches, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__SWITCHES, newSwitches, newSwitches));
	}
	...
	public NotificationChain basicSetUpdateRates(UpdateRatesType newUpdateRates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__UPDATE_RATES, oldUpdateRates, newUpdateRates);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUpdateRates(UpdateRatesType newUpdateRates) {
		if (newUpdateRates != updateRates) {
			NotificationChain msgs = null;
			if (updateRates != null)
				msgs = ((InternalEObject)updateRates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__UPDATE_RATES, null, msgs);
			if (newUpdateRates != null)
				msgs = ((InternalEObject)newUpdateRates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__UPDATE_RATES, null, msgs);
			msgs = basicSetUpdateRates(newUpdateRates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__UPDATE_RATES, newUpdateRates, newUpdateRates));
	}
	...
	public NotificationChain basicSetDataTypes(DataTypesType newDataTypes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__DATA_TYPES, oldDataTypes, newDataTypes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataTypes(DataTypesType newDataTypes) {
		if (newDataTypes != dataTypes) {
			NotificationChain msgs = null;
			if (dataTypes != null)
				msgs = ((InternalEObject)dataTypes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__DATA_TYPES, null, msgs);
			if (newDataTypes != null)
				msgs = ((InternalEObject)newDataTypes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__DATA_TYPES, null, msgs);
			msgs = basicSetDataTypes(newDataTypes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__DATA_TYPES, newDataTypes, newDataTypes));
	}
	...
	public NotificationChain basicSetNotes(NotesType newNotes, NotificationChain msgs) {
		...
		notes = newNotes;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__NOTES, oldNotes, newNotes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNotes(NotesType newNotes) {
		if (newNotes != notes) {
			NotificationChain msgs = null;
			if (notes != null)
				msgs = ((InternalEObject)notes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__NOTES, null, msgs);
			if (newNotes != null)
				msgs = ((InternalEObject)newNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.OBJECT_MODEL_TYPE__NOTES, null, msgs);
			msgs = basicSetNotes(newNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__NOTES, newNotes, newNotes));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, OmtPackage.OBJECT_MODEL_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIdtag(String newIdtag) {
		...
		idtag = newIdtag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes1(List<String> newNotes1) {
		...
		notes1 = newNotes1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.OBJECT_MODEL_TYPE__NOTES1, oldNotes1, notes1));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.OBJECT_MODEL_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
