 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#getIsCallback <em>Is Callback</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#isIsUsed <em>Is Used</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GetOrderTypeTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetOrderTypeTypeImpl extends MinimalEObjectImpl.Container implements GetOrderTypeType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getGetOrderTypeType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GET_ORDER_TYPE_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setIsCallback(Object newIsCallback) {
		...
		isCallbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GET_ORDER_TYPE_TYPE__IS_CALLBACK, oldIsCallback, isCallback, !oldIsCallbackESet));
	}
	...
	public void unsetIsCallback() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.GET_ORDER_TYPE_TYPE__IS_CALLBACK, oldIsCallback, IS_CALLBACK_EDEFAULT, oldIsCallbackESet));
	}
	...
	public void setIsUsed(boolean newIsUsed) {
		...
		isUsedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GET_ORDER_TYPE_TYPE__IS_USED, oldIsUsed, isUsed, !oldIsUsedESet));
	}
	...
	public void unsetIsUsed() {
		...
		isUsedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.GET_ORDER_TYPE_TYPE__IS_USED, oldIsUsed, IS_USED_EDEFAULT, oldIsUsedESet));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GET_ORDER_TYPE_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setSection(Object newSection) {
		...
		sectionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GET_ORDER_TYPE_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.GET_ORDER_TYPE_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.GET_ORDER_TYPE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OmtPackage.GET_ORDER_TYPE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OmtPackage.GET_ORDER_TYPE_TYPE__IDTAG:
				return getIdtag();
			case OmtPackage.GET_ORDER_TYPE_TYPE__IS_CALLBACK:
				return getIsCallback();
			case OmtPackage.GET_ORDER_TYPE_TYPE__IS_USED:
				return isIsUsed();
			case OmtPackage.GET_ORDER_TYPE_TYPE__NOTES:
				return getNotes();
			case OmtPackage.GET_ORDER_TYPE_TYPE__SECTION:
				return getSection();
			case OmtPackage.GET_ORDER_TYPE_TYPE__ANY_ATTRIBUTE:
