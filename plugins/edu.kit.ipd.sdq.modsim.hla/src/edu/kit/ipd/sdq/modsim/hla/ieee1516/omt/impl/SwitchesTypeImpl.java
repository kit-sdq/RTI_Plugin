 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAutoProvide <em>Auto Provide</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getConveyRegionDesignatorSets <em>Convey Region Designator Sets</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getConveyProducingFederate <em>Convey Producing Federate</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAttributeScopeAdvisory <em>Attribute Scope Advisory</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAttributeRelevanceAdvisory <em>Attribute Relevance Advisory</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getObjectClassRelevanceAdvisory <em>Object Class Relevance Advisory</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getInteractionRelevanceAdvisory <em>Interaction Relevance Advisory</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getServiceReporting <em>Service Reporting</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getExceptionReporting <em>Exception Reporting</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getDelaySubscriptionEvaluation <em>Delay Subscription Evaluation</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAutomaticResignAction <em>Automatic Resign Action</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.SwitchesTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchesTypeImpl extends MinimalEObjectImpl.Container implements SwitchesType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getSwitchesType();
	}
	...
	public NotificationChain basicSetAutoProvide(SwitchType newAutoProvide, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__AUTO_PROVIDE, oldAutoProvide, newAutoProvide);
	...
	public void setAutoProvide(SwitchType newAutoProvide) {
		if (newAutoProvide != autoProvide) {
			...
			if (autoProvide != null)
				msgs = ((InternalEObject)autoProvide).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__AUTO_PROVIDE, null, msgs);
			if (newAutoProvide != null)
				msgs = ((InternalEObject)newAutoProvide).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__AUTO_PROVIDE, null, msgs);
			msgs = basicSetAutoProvide(newAutoProvide, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__AUTO_PROVIDE, newAutoProvide, newAutoProvide));
	}
	...
	public NotificationChain basicSetConveyRegionDesignatorSets(SwitchType newConveyRegionDesignatorSets, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__CONVEY_REGION_DESIGNATOR_SETS, oldConveyRegionDesignatorSets, newConveyRegionDesignatorSets);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConveyRegionDesignatorSets(SwitchType newConveyRegionDesignatorSets) {
		if (newConveyRegionDesignatorSets != conveyRegionDesignatorSets) {
			...
			if (conveyRegionDesignatorSets != null)
				msgs = ((InternalEObject)conveyRegionDesignatorSets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__CONVEY_REGION_DESIGNATOR_SETS, null, msgs);
			if (newConveyRegionDesignatorSets != null)
				msgs = ((InternalEObject)newConveyRegionDesignatorSets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__CONVEY_REGION_DESIGNATOR_SETS, null, msgs);
			msgs = basicSetConveyRegionDesignatorSets(newConveyRegionDesignatorSets, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__CONVEY_REGION_DESIGNATOR_SETS, newConveyRegionDesignatorSets, newConveyRegionDesignatorSets));
	}
	...
	public NotificationChain basicSetConveyProducingFederate(SwitchType newConveyProducingFederate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__CONVEY_PRODUCING_FEDERATE, oldConveyProducingFederate, newConveyProducingFederate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConveyProducingFederate(SwitchType newConveyProducingFederate) {
		if (newConveyProducingFederate != conveyProducingFederate) {
			...
			if (conveyProducingFederate != null)
				msgs = ((InternalEObject)conveyProducingFederate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__CONVEY_PRODUCING_FEDERATE, null, msgs);
			if (newConveyProducingFederate != null)
				msgs = ((InternalEObject)newConveyProducingFederate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__CONVEY_PRODUCING_FEDERATE, null, msgs);
			msgs = basicSetConveyProducingFederate(newConveyProducingFederate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__CONVEY_PRODUCING_FEDERATE, newConveyProducingFederate, newConveyProducingFederate));
	}
	...
	public NotificationChain basicSetAttributeScopeAdvisory(SwitchType newAttributeScopeAdvisory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__ATTRIBUTE_SCOPE_ADVISORY, oldAttributeScopeAdvisory, newAttributeScopeAdvisory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAttributeScopeAdvisory(SwitchType newAttributeScopeAdvisory) {
		if (newAttributeScopeAdvisory != attributeScopeAdvisory) {
			...
			if (attributeScopeAdvisory != null)
				msgs = ((InternalEObject)attributeScopeAdvisory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__ATTRIBUTE_SCOPE_ADVISORY, null, msgs);
			if (newAttributeScopeAdvisory != null)
				msgs = ((InternalEObject)newAttributeScopeAdvisory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__ATTRIBUTE_SCOPE_ADVISORY, null, msgs);
			msgs = basicSetAttributeScopeAdvisory(newAttributeScopeAdvisory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__ATTRIBUTE_SCOPE_ADVISORY, newAttributeScopeAdvisory, newAttributeScopeAdvisory));
	}
	...
	public NotificationChain basicSetAttributeRelevanceAdvisory(SwitchType newAttributeRelevanceAdvisory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__ATTRIBUTE_RELEVANCE_ADVISORY, oldAttributeRelevanceAdvisory, newAttributeRelevanceAdvisory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAttributeRelevanceAdvisory(SwitchType newAttributeRelevanceAdvisory) {
		if (newAttributeRelevanceAdvisory != attributeRelevanceAdvisory) {
			...
			if (attributeRelevanceAdvisory != null)
				msgs = ((InternalEObject)attributeRelevanceAdvisory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__ATTRIBUTE_RELEVANCE_ADVISORY, null, msgs);
			if (newAttributeRelevanceAdvisory != null)
				msgs = ((InternalEObject)newAttributeRelevanceAdvisory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__ATTRIBUTE_RELEVANCE_ADVISORY, null, msgs);
			msgs = basicSetAttributeRelevanceAdvisory(newAttributeRelevanceAdvisory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__ATTRIBUTE_RELEVANCE_ADVISORY, newAttributeRelevanceAdvisory, newAttributeRelevanceAdvisory));
	}
	...
	public NotificationChain basicSetObjectClassRelevanceAdvisory(SwitchType newObjectClassRelevanceAdvisory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__OBJECT_CLASS_RELEVANCE_ADVISORY, oldObjectClassRelevanceAdvisory, newObjectClassRelevanceAdvisory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setObjectClassRelevanceAdvisory(SwitchType newObjectClassRelevanceAdvisory) {
		if (newObjectClassRelevanceAdvisory != objectClassRelevanceAdvisory) {
			...
			if (objectClassRelevanceAdvisory != null)
				msgs = ((InternalEObject)objectClassRelevanceAdvisory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__OBJECT_CLASS_RELEVANCE_ADVISORY, null, msgs);
			if (newObjectClassRelevanceAdvisory != null)
				msgs = ((InternalEObject)newObjectClassRelevanceAdvisory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__OBJECT_CLASS_RELEVANCE_ADVISORY, null, msgs);
			msgs = basicSetObjectClassRelevanceAdvisory(newObjectClassRelevanceAdvisory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__OBJECT_CLASS_RELEVANCE_ADVISORY, newObjectClassRelevanceAdvisory, newObjectClassRelevanceAdvisory));
	}
	...
	public NotificationChain basicSetInteractionRelevanceAdvisory(SwitchType newInteractionRelevanceAdvisory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__INTERACTION_RELEVANCE_ADVISORY, oldInteractionRelevanceAdvisory, newInteractionRelevanceAdvisory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInteractionRelevanceAdvisory(SwitchType newInteractionRelevanceAdvisory) {
		if (newInteractionRelevanceAdvisory != interactionRelevanceAdvisory) {
			...
			if (interactionRelevanceAdvisory != null)
				msgs = ((InternalEObject)interactionRelevanceAdvisory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__INTERACTION_RELEVANCE_ADVISORY, null, msgs);
			if (newInteractionRelevanceAdvisory != null)
				msgs = ((InternalEObject)newInteractionRelevanceAdvisory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__INTERACTION_RELEVANCE_ADVISORY, null, msgs);
			msgs = basicSetInteractionRelevanceAdvisory(newInteractionRelevanceAdvisory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__INTERACTION_RELEVANCE_ADVISORY, newInteractionRelevanceAdvisory, newInteractionRelevanceAdvisory));
	}
	...
	public NotificationChain basicSetServiceReporting(SwitchType newServiceReporting, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__SERVICE_REPORTING, oldServiceReporting, newServiceReporting);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setServiceReporting(SwitchType newServiceReporting) {
		if (newServiceReporting != serviceReporting) {
			...
			if (serviceReporting != null)
				msgs = ((InternalEObject)serviceReporting).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__SERVICE_REPORTING, null, msgs);
			if (newServiceReporting != null)
				msgs = ((InternalEObject)newServiceReporting).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__SERVICE_REPORTING, null, msgs);
			msgs = basicSetServiceReporting(newServiceReporting, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__SERVICE_REPORTING, newServiceReporting, newServiceReporting));
	}
	...
	public NotificationChain basicSetExceptionReporting(SwitchType newExceptionReporting, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__EXCEPTION_REPORTING, oldExceptionReporting, newExceptionReporting);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExceptionReporting(SwitchType newExceptionReporting) {
		if (newExceptionReporting != exceptionReporting) {
			...
			if (exceptionReporting != null)
				msgs = ((InternalEObject)exceptionReporting).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__EXCEPTION_REPORTING, null, msgs);
			if (newExceptionReporting != null)
				msgs = ((InternalEObject)newExceptionReporting).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__EXCEPTION_REPORTING, null, msgs);
			msgs = basicSetExceptionReporting(newExceptionReporting, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__EXCEPTION_REPORTING, newExceptionReporting, newExceptionReporting));
	}
	...
	public NotificationChain basicSetDelaySubscriptionEvaluation(SwitchType newDelaySubscriptionEvaluation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__DELAY_SUBSCRIPTION_EVALUATION, oldDelaySubscriptionEvaluation, newDelaySubscriptionEvaluation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDelaySubscriptionEvaluation(SwitchType newDelaySubscriptionEvaluation) {
		if (newDelaySubscriptionEvaluation != delaySubscriptionEvaluation) {
			...
			if (delaySubscriptionEvaluation != null)
				msgs = ((InternalEObject)delaySubscriptionEvaluation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__DELAY_SUBSCRIPTION_EVALUATION, null, msgs);
			if (newDelaySubscriptionEvaluation != null)
				msgs = ((InternalEObject)newDelaySubscriptionEvaluation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__DELAY_SUBSCRIPTION_EVALUATION, null, msgs);
			msgs = basicSetDelaySubscriptionEvaluation(newDelaySubscriptionEvaluation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__DELAY_SUBSCRIPTION_EVALUATION, newDelaySubscriptionEvaluation, newDelaySubscriptionEvaluation));
	}
	...
	public NotificationChain basicSetAutomaticResignAction(ResignSwitchType newAutomaticResignAction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__AUTOMATIC_RESIGN_ACTION, oldAutomaticResignAction, newAutomaticResignAction);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAutomaticResignAction(ResignSwitchType newAutomaticResignAction) {
		if (newAutomaticResignAction != automaticResignAction) {
			...
			if (automaticResignAction != null)
				msgs = ((InternalEObject)automaticResignAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__AUTOMATIC_RESIGN_ACTION, null, msgs);
			if (newAutomaticResignAction != null)
				msgs = ((InternalEObject)newAutomaticResignAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OmtPackage.SWITCHES_TYPE__AUTOMATIC_RESIGN_ACTION, null, msgs);
			msgs = basicSetAutomaticResignAction(newAutomaticResignAction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__AUTOMATIC_RESIGN_ACTION, newAutomaticResignAction, newAutomaticResignAction));
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, OmtPackage.SWITCHES_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIdtag(String newIdtag) {
		...
		idtag = newIdtag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.SWITCHES_TYPE__NOTES, oldNotes, notes));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.SWITCHES_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
