 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#getIsCallback <em>Is Callback</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#isIsUsed <em>Is Used</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.FederateSaveCompleteTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FederateSaveCompleteTypeImpl extends MinimalEObjectImpl.Container implements FederateSaveCompleteType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getFederateSaveCompleteType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setIsCallback(Object newIsCallback) {
		...
		isCallbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_CALLBACK, oldIsCallback, isCallback, !oldIsCallbackESet));
	}
	...
	public void unsetIsCallback() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_CALLBACK, oldIsCallback, IS_CALLBACK_EDEFAULT, oldIsCallbackESet));
	}
	...
	public void setIsUsed(boolean newIsUsed) {
		...
		isUsedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_USED, oldIsUsed, isUsed, !oldIsUsedESet));
	}
	...
	public void unsetIsUsed() {
		...
		isUsedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_USED, oldIsUsed, IS_USED_EDEFAULT, oldIsUsedESet));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setSection(Object newSection) {
		...
		sectionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IDTAG:
				return getIdtag();
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_CALLBACK:
				return getIsCallback();
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__IS_USED:
				return isIsUsed();
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__NOTES:
				return getNotes();
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__SECTION:
				return getSection();
			case OmtPackage.FEDERATE_SAVE_COMPLETE_TYPE__ANY_ATTRIBUTE:
