 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getAlt <em>Alt</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.GlyphTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GlyphTypeImpl extends MinimalEObjectImpl.Container implements GlyphType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getGlyphType();
	}
	...
	public void setValue(byte[] newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__VALUE, oldValue, value));
	}
	...
	public void setAlt(String newAlt) {
		...
		alt = newAlt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__ALT, oldAlt, alt));
	}
	...
	public void setHeight(short newHeight) {
		...
		heightESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__HEIGHT, oldHeight, height, !oldHeightESet));
	}
	...
	public void unsetHeight() {
		...
		heightESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.GLYPH_TYPE__HEIGHT, oldHeight, HEIGHT_EDEFAULT, oldHeightESet));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__HREF, oldHref, href));
	}
	...
	public void setIdtag(String newIdtag) {
		...
		idtag = newIdtag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setType(Object newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__TYPE, oldType, type));
	}
	...
	public void setWidth(short newWidth) {
		...
		widthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.GLYPH_TYPE__WIDTH, oldWidth, width, !oldWidthESet));
	}
	...
	public void unsetWidth() {
		...
		widthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OmtPackage.GLYPH_TYPE__WIDTH, oldWidth, WIDTH_EDEFAULT, oldWidthESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.GLYPH_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
