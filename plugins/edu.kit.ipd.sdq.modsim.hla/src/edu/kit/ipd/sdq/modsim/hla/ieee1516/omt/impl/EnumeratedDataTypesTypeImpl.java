 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.EnumeratedDataTypesTypeImpl#getEnumeratedData <em>Enumerated Data</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.EnumeratedDataTypesTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.EnumeratedDataTypesTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.EnumeratedDataTypesTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.modsim.hla.ieee1516.omt.impl.EnumeratedDataTypesTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumeratedDataTypesTypeImpl extends MinimalEObjectImpl.Container implements EnumeratedDataTypesType {
	...
	protected EClass eStaticClass() {
		return OmtPackage.eINSTANCE.getEnumeratedDataTypesType();
	}
	...
	public EList<EnumeratedDataType1> getEnumeratedData() {
		if (enumeratedData == null) {
			enumeratedData = new EObjectContainmentEList<EnumeratedDataType1>(EnumeratedDataType1.class, this, OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ENUMERATED_DATA);
		}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ANY);
		}
		return any;
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.ENUMERATED_DATA_TYPES_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List<String> newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OmtPackage.ENUMERATED_DATA_TYPES_TYPE__NOTES, oldNotes, notes));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ENUMERATED_DATA:
				return ((InternalEList<?>)getEnumeratedData()).basicRemove(otherEnd, msgs);
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ANY:
				return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__IDTAG:
				return getIdtag();
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__NOTES:
				return getNotes();
			case OmtPackage.ENUMERATED_DATA_TYPES_TYPE__ANY_ATTRIBUTE:
